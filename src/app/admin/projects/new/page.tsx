...
export default function NewProjectPage() {
    ...
    const onSubmit = async (data: ProjectInput) => {
        ...
        try {
            ...
            toast.error(error.message || "Errore durante la creazione del progetto");
        } finally {
            setIsLoading(false);
        }
    };
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight">Nuovo Progetto</h1>
                            <p className="text-muted-foreground">Crea un nuovo progetto per il portfolio.</p>
                        </div>
                    </div>
                </div>
